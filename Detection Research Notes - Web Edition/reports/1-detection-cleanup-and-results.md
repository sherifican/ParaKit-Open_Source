...
> **Status — June 2026:** the cleanup described here is **now live in ParaKit as of v4.5.0-1** — it runs automatically on Audio → MIDI conversions (toggleable under Advanced). This report documents the research behind it.
